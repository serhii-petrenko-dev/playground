...
import io.xps.playground.databinding.FragmentMultipleCamBinding
...
//        backgroundHandler?.post(ImageSaver(it.acquireNextImage(), file))
    ...
    private val stateCallbackFront = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@MultipleCameraFragment.cameraDeviceFront = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLockFront.release()
            cameraDevice.close()
            this@MultipleCameraFragment.cameraDeviceFront = null
        }
    ...
    private val stateCallbackRear = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@MultipleCameraFragment.cameraDeviceRear = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLockRear.release()
            cameraDevice.close()
            this@MultipleCameraFragment.cameraDeviceRear = null
        }
    ...
    private fun createCameraPreviewSessionFront() {
        try {
            ...
            cameraDeviceFront?.createCaptureSession(
                Arrays.asList(surface, imageReaderFront?.surface),
